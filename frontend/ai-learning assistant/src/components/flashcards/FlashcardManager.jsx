...
<div className="flex items-center gap-6">
  ...
  <div className="px-4 py-2 bg-slate-50 rounded-lg bprder border-slate-200">
  ...
  <button
    ...
    disabled={selectedSet.cards.length <= 1}
    className="group flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transition-all  duration-200  active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100">
