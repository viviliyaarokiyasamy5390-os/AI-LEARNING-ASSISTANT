      ...
      <div key={index} className={`flex items-start gap-3 my-4 ${isUser? 'justify-end' : ''}`}>
        {!isUser && (
          <div className="w-9 h-9 rounded-xl bg-emerald-100 flex items-center justify-center flex-shrink-0">
            <Sparkles className="text-emerald-600" strokeWidth={2} />
          </div>
        )}
        ...
        {isUser && (
          <div className="w-8 h-8 rounded-full bg-emerald-600 flex items-center justify-center flex-shrink-0 text-white font-semibold text-sm">
    ...
    <div className="flex-1 p-6 overflow-y-auto bg-gradient-to-br from-slate-50/50 via-white/50 to-slate-50/50">
      ...
      {loading && (
        <div className="flex items-center gap-3 my-4">
          ...
          <div className="flex items-center gap-2 px-4 py-3 rounded-xl rounded-bl-md bg-white border-slate-200/60">
