...
const AIActions = () => {
    ...
    console.log("AI Actions rendered");
  ...
  return (
    ...
    <div className="bg-white/80 backdrop-blur-xl border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">

      {/* Header */}
      <div className="px-6 py-5 border-b border-slate-200/60 bg-gradient-to-r from-slate-50/50 to-white/50">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 shadow-lg shadow-emerald-500/25 flex items-center justify-center">
      ...
      <div className="p-6 space-y-6">
        {/* Generate Summary */}
        <div className="group p-5 bg-gradient-to-r from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all duration-200">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-gray-900">Generate Summary</h4>
              </div>
...
<Modal
  ...
  title={modalTitle}
>
  <div className="max-h-[75vh] overflow-y-auto  max-w-none prose prose-slate">
