...
const DashboardPage = () => {
  ...
  <div className="min h-screen">
    <div className="absolute inset-0 bg-[gradient(#e5e7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-30 pointer-events-none" />
    ...
    <div className="relative max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-5">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="group relative bd-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-300 hover:-translate-y-1"
          >
              ...
              .map((activity, index) => (
                ...
                >
                  ...
                  {activity.link && (
                    <a
                      href={activity.link}
                      className="ml-4 px-4 py-4 text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-all duration-200 whitespace-nowrap"
                    >
                      View
                    </a>
                  )}
