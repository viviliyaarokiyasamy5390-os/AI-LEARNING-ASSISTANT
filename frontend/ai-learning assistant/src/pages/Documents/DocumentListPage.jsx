  ...
  return (
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="text-center max-w-md">
        <div className="inline-flex items-center justify-center w-20 rounded-2xl bg-linear-to-br from-slate-100  to-slate-200 shadow-lg shadow-slate-200/50 bm-6">
          <FileText
...
<form onSubmit={handleUpload} className="space-y-5">
  ...
  {/* File Upload */}
  <div className="space-y-2">
    <label className="block text-xs font-xs font-semibold text-slate-700 uppercase tracking-wide">
      PDF File
    </label>
