    ...
    <div className="relative w-full max-w-md px-6">
      <div className="bg-white/80 backdrop-blur-xl border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br from-emeraled-400 to-teal-600 shadow-lg shadow-emeraled-500/25 mb-6">
            <BrainCircuit className="w-7 h-7text-white" strokeWidth={2} />
          </div>
          <h1 className="text-2xl font-medium font-slate-900 tracking-tight mb-2">
            Welcome back
          </h1>
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slte-50/50 text-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emeraled-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10 "
        ...
        {/* Footer */}
        <div className="nt-8 pt-6 border-t border-slate-200/60">
        ...
        {/* Subtle footer text */}
          ...
          <p className="text-center text-xs  text-slate-600 nt-6">
